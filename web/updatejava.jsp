...
<%
    String tn="ques_of_java";
Class.forName("oracle.jdbc.OracleDriver");
Connection con=DriverManager.getConnection
        ("jdbc:oracle:thin:@localhost:1521:xe","System","root");
String query="select * from ques_of_java";
...
con.close();
out.println("<table border=2 align=center><tr><td>Q.No.</td><td>QUES</td><td>A</td><td>B</td><td>C</td><td>D</td><td>CORRECT ANSWER</td></tr>");
for(User1 b:u)
{
 out.print("<br><tr><td>"+b.getQno()+"</td><td>"+b.getQues()+"</td><td>"+b.getAns1()+"</td><td>"+b.getAns2()+"</td><td>"+b.getAns3()+"</td><td>"+b.getAns4()+"</td><td>"+b.getCa()+"</td></tr>");   
}
out.println("</table>");
%>
<div align="right"> 
<form action="delques.jsp" method="post">
    <input type="hidden" name="lang" value="ques_of_java">
    <input type="submit" value="DELETE" onclick="location.href='delques.jsp'"></form></div>

<div align="left">
<form action="updateq.jsp" method="post">
    Update Ques Number:
    <input type="text" class="fmt" name="qno" id="123">
    <input type="hidden" name="lang" value="ques_of_java">
